...
export const renderLogosEditor = ({ draft, registry, validation }) => {
  ...
  return renderEditorWorkspace({ sectionId: "logos", eyebrow: "Brand Presentation", title: "Logos & Marks", copy: "Adjust logo visibility, alternate text, fit, zoom, and focal position.", body, issueCount: validation.issueCounts.logos, status: validation.statuses.logos });
};
